    ...
    return (
        <Modal data-cy="modal-delete" show={show} onHide={handleClose} size="md">
            <Modal.Body className="flex flex-col justify-center items-center text-center">
                ...
                <h1 data-cy="modal-delete-title" className="text-lg my-14">Apakah anda yakin menghapus List Item <p className="font-extrabold">"Telur ayam"?</p></h1>
                <div className="flex w-full justify-center">
                    ...
                    <button onClick={handleClose} data-cy="modal-deletet-confirm-button" className="font-bold text-lg bg-red-500 mx-2 py-3 px-10 rounded-full text-white"> Hapus</button>
                </div>
            </Modal.Body>
        </Modal>
    );
